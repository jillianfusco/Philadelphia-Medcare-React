...
export default function ChooseUs() {
    return(
        ...
        <p>
            ...
            <h3>Testimonials</h3>
            <p>Coming soon!</p>
            {/* <p>"The team at Philadelphia Medcare DCPC helped me recover after my car accident. They truly care about their patients!" - Sarah W. <br />
                "I was in so much pain from a work injury, but after a few sessions here, I feel like myself again. Highly recommend!" - James L.</p> */}
        </p>
    </section>
    )
}